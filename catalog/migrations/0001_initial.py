# Generated by Django 2.0 on 2017-12-23 06:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(help_text='Enter first name not more than 100 chars', max_length=100)),
                ('last_name', models.CharField(help_text='Enter last name not more than 100 chars', max_length=100)),
                ('date_of_birth', models.DateField(blank=True, null=True, verbose_name='DOB')),
                ('date_of_death', models.DateField(blank=True, null=True, verbose_name='DOD')),
            ],
        ),
        migrations.CreateModel(
            name='Book',
